package com.bwei.huanghui201707171504d.ui;
...
import com.bwei.huanghui201707171504d.adapter.MyAdapter;
...
public class MainActivity extends AppCompatActivity implements MyAdapter.onCheckListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //反选
        cb_fanxuan.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
    ...
    private void tojson() {
        try {
            ...
            for (int i = 0; i < 30; i++) {
                ...
                goodss.setTitle("这是一个商品" + i);
                goodss.setMoney("236");
                goodss.setFlag(false);
                goods.add(goodss);
            }
